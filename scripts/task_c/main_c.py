...
train_bs = 64
train_set = MN40ClsParaLoader(data_root, 'train')
...
for epc in range(1, num_epc+1):
    ...
    cond_1 = (train_acc<=90.0 and np.mod(epc, 5)==0)
    cond_2 = (train_acc>=90.0 and train_acc<=95.0 and np.mod(epc, 2)==0)
    cond_3 = (train_acc>=95.0 and np.mod(epc, 1)==0)
